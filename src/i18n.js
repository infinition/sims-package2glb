...
const DICTIONARY = {
  en: {
    ...
    "warn.sims2_no_texture": "Sims 2: geometry found, no usable texture in the package",
  ...
  fr: {
    ...
    "warn.sims2_no_texture": "Sims 2 : geometrie trouvee, aucune texture exploitable dans le package",
